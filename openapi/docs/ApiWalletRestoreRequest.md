...
GetPoolColdId returns the PoolColdId field if non-nil, zero value otherwise.

### GetPoolColdIdOk

`func (o *ApiWalletRestoreRequest) GetPoolColdIdOk() (*int32, bool)`

GetPoolColdIdOk returns a tuple with the PoolColdId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetPoolColdId sets PoolColdId field to given value.
