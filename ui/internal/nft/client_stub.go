...
// client. Boot uses it to leave default (non-nftmedia) builds unchanged: no NFT
// service is constructed and therefore no NFT cache directory is created.
func MediaAvailable() bool { return false }
