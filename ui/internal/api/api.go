...
// settings exposes user-facing app settings (the lean-node profile).
...
func NewHandler(st Statuser, wl Wallet, sp Spender, settings SettingsController, network string, spa http.Handler) http.Handler {
