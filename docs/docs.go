    ...
    "paths": {
        ...
        "/api/address/enumerate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Address Enumerate Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Enumerated addresses",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/bursa.EnumeratedAddress"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/sign/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Verify Data Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/bursa.TxInspection"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/tx/sign": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Transaction + signing keys",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/tx/witness": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Transaction + signing key",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
